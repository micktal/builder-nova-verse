...
import { 
  Users, ArrowLeft, CheckCircle, Home, 
  MessageSquare, Play, ArrowRight, ThumbsUp, ThumbsDown, AlertCircle
} from 'lucide-react';

const Sequence4 = () => {
  const [currentStep, setCurrentStep] = useState<'intro' | 'learning' | 'practice' | 'completion'>('intro');
  const [currentScenario, setCurrentScenario] = useState(0);
  const [scenarioChoices, setScenarioChoices] = useState<{[key: number]: string}>({});
  const [communicationStyleQuiz, setCommunicationStyleQuiz] = useState<{[key: number]: string}>({});
  ...
  const descModel = [
    ...
    },
    {
      ...
      example: '"...pour que nos réunions soient plus efficaces et respectueuses."',
      color: 'blue'
    }
  ];
  ...
  const communicationStyles = [
    {
      style: 'Passif',
      characteristics: 'Évite les conflits, n\'exprime pas ses besoins, dit toujours oui',
      consequence: 'Frustration interne, stress accumulé, perte d\'estime de soi',
      example: '"Bon... d\'accord... je vais le faire..."',
      color: 'gray'
    },
    {
      style: 'Agressif', 
      characteristics: 'Impose ses idées, ne respecte pas les autres, ton directif',
  ...
  const scenarios = [
    {
      ...
      context: 'Votre manager vous demande de rester tard pour finir un projet non urgent, mais vous avez des engagements personnels importants.',
      choices: [
        {
          id: 'passive',
          text: 'D\'accord... je vais rester... (en soupirant)',
          style: 'Passif',
          feedback: 'Vous acceptez au détriment de votre équilibre. Cela peut créer de la frustration et du ressentiment.',
        ...
        },
        {
          ...
          style: 'Agressif',
          feedback: 'Votre refus est trop brutal et peut créer des tensions avec votre hiérarchie.',
        ...
        },
        {
          ...
          style: 'Assertif', 
          feedback: 'Parfait ! Vous reconnaissez la demande tout en proposant une alternative constructive.',
    ...
    },
    {
      ...
      context: 'Un collègue vous interrompt régulièrement pendant vos tâches importantes, ce qui nuit à votre concentration.',
      choices: [
        {
          id: 'passive',
          text: 'Je continue à l\'écouter en espérant qu\'il comprenne...',
          style: 'Passif',
          feedback: 'Ignorer le problème ne le résout pas. Votre productivité et votre stress en pâtissent.',
        ...
        },
        {
          ...
          style: 'Assertif',
          feedback: 'Excellent ! Vous valorisez la relation tout en protégeant votre temps de travail.',
        ...
        },
        {
          ...
          style: 'Agressif', 
          feedback: 'Votre frustration est compréhensible mais cette réaction peut blesser et détériorer la relation.',
    ...
    },
    {
      ...
      context: 'Vous souhaitez négocier une augmentation avec votre manager après une année de bons résultats.',
      choices: [
        {
          id: 'passive',
          text: 'Euh... je me demandais si... peut-être... une petite augmentation...',
          style: 'Passif',
          feedback: 'Votre manque de confiance ne valorise pas vos compétences. Soyez plus affirmatif.',
        ...
        },
        {
          ...
          style: 'Agressif',
          feedback: 'Le ton est trop exigeant. Une approche plus collaborative sera mieux reçue.',
        ...
        },
        {
          ...
          style: 'Assertif',
          feedback: 'Parfait ! Vous êtes direct, factuel et vous ouvrez le dialogue de manière professionnelle.',
  ...
  const quizQuestions = [
    {
      question: 'Dans quelle situation la communication assertive est-elle la plus appropriée ?',
      options: [
    ...
    {
      question: 'Quelle est la principale différence entre assertif et agressif ?',
      options: [
  ...
  const handleQuizAnswer = (questionIndex: number, answer: string) => {
    ...
    if (Object.keys(communicationStyleQuiz).length + 1 === quizQuestions.length && !completedExercises.includes('quiz')) {
      setCompletedExercises(prev => [...prev, 'quiz']);
    }
  };

  const isSequenceComplete = completedExercises.includes('scenarios') && completedExercises.includes('quiz');
    ...
    <div className="max-w-4xl mx-auto text-center mb-8">
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-calm-200">
        ...
        <p className="text-xl text-gray-600 mb-6 leading-relaxed">
          ...
          les relations difficiles avec le modèle DESC et des techniques d'assertivité.
        </p>
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          <div className="text-center p-4 bg-calm-50 rounded-lg">
            ...
            <p className="text-xs text-gray-600 mt-1">Structure de communication</p>
          </div>
          <div className="text-center p-4 bg-calm-50 rounded-lg">
            <Users className="w-8 h-8 mx-auto mb-2 text-calm-600" />
            <h4 className="font-semibold text-sm text-gray-900">3 Styles</h4>
            <p className="text-xs text-gray-600 mt-1">Passif, Agressif, Assertif</p>
          </div>
          <div className="text-center p-4 bg-calm-50 rounded-lg">
        ...
        <div className="bg-blue-50 p-6 rounded-lg mb-6">
          <h3 className="font-semibold text-blue-900 mb-2">Dans cette séquence :</h3>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <p className="text-gray-600 mb-6">
            Structure simple et efficace pour exprimer vos besoins de manière claire et respectueuse, 
            particulièrement utile dans les situations délicates.
          </p>
          <div className="grid md:grid-cols-4 gap-4 mb-6">
            {descModel.map((step, index) => (
              <div key={step.letter} className={`text-center p-6 bg-${step.color}-50 rounded-lg border border-${step.color}-200`}>
                <div className={`w-16 h-16 bg-${step.color}-500 text-white rounded-full flex items-center justify-center font-bold text-2xl mx-auto mb-4`}>
                  {step.letter}
                </div>
                <h4 className={`font-bold text-${step.color}-700 mb-2`}>{step.title}</h4>
                <p className="text-gray-600 text-sm mb-3">{step.description}</p>
                <div className={`bg-${step.color}-100 p-3 rounded text-xs italic text-${step.color}-800`}>
                  {step.example}
                </div>
              </div>
            ))}
          ...
          <div className="bg-green-50 p-6 rounded-lg border border-green-200">
            <h5 className="font-semibold text-green-800 mb-3">Exemple complet :</h5>
            <div className="text-green-700 text-sm space-y-2">
              <p><strong>D :</strong> "Quand tu arrives en retard aux réunions..."</p>
              <p><strong>E :</strong> "...je me sens frustré car cela retarde nos décisions..."</p>
              <p><strong>S :</strong> "...j'aimerais que nous puissions tous arriver à l'heure..."</p>
              <p><strong>C :</strong> "...pour que nos réunions soient plus efficaces et respectueuses du temps de chacun."</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="grid md:grid-cols-3 gap-6">
            {communicationStyles.map((style, index) => (
              <div key={style.style} className={`p-6 rounded-lg border-2 border-${style.color}-200 bg-${style.color}-50`}>
                <h4 className={`font-bold text-${style.color}-700 text-lg mb-3`}>{style.style}</h4>
                
                <div className="mb-4">
                  <h5 className="font-semibold text-gray-800 text-sm mb-2">Caractéristiques :</h5>
                  <p className="text-gray-600 text-sm">{style.characteristics}</p>
                </div>
                
                <div className="mb-4">
                  <h5 className="font-semibold text-gray-800 text-sm mb-2">Exemple :</h5>
                  <div className={`bg-white p-3 rounded border border-${style.color}-300 text-${style.color}-800 text-sm italic`}>
                    {style.example}
                  </div>
                </div>
                
                <div>
                  <h5 className="font-semibold text-gray-800 text-sm mb-2">Conséquences :</h5>
          ...
          <div className="mt-6 bg-yellow-50 p-6 rounded-lg border border-yellow-200">
            <h5 className="font-semibold text-yellow-800 mb-2">💡 Point clé :</h5>
            <p className="text-yellow-700 text-sm">
              L'assertivité n'est ni de la passivité ni de l'agressivité. C'est l'art de s'affirmer 
              tout en respectant les autres, créant ainsi des relations saines et efficaces.
            </p>
          </div>
        </CardContent>
      </Card>
  ...
  const PracticeStep = () => (
    <div className="max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <Progress value={(completedExercises.length / 2) * 100} className="h-3 mb-4" />
      </div>
      ...
      <Card className="mb-8">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Sc��nario {currentScenario + 1}/{scenarios.length}: {scenarios[currentScenario].title}
            {completedExercises.includes('scenarios') && <CheckCircle className="w-5 h-5 text-green-500" />}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            <div className="p-6 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-800">{scenarios[currentScenario].context}</p>
            </div>

            <div className="space-y-4">
              <h4 className="font-semibold text-gray-900">Comment réagissez-vous ?</h4>
                ...
                <div key={choice.id} className="space-y-3">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <Badge 
                        variant="outline" 
                        className={choice.style === 'Assertif' ? 'border-green-500 text-green-700' : 
                                 choice.style === 'Passif' ? 'border-gray-500 text-gray-700' : 
                  ...
                  {scenarioChoices[currentScenario] === choice.id && (
                    <div className={`p-4 rounded-lg border ${
                      choice.style === 'Assertif' ? 'bg-green-50 border-green-200' :
                      choice.style === 'Passif' ? 'bg-gray-50 border-gray-200' :
                      'bg-red-50 border-red-200'
                    }`}>
                      <div className="space-y-3">
                        <div>
                          <h6 className={`font-semibold text-sm ${
                            choice.style === 'Assertif' ? 'text-green-800' :
                            choice.style === 'Passif' ? 'text-gray-800' :
                            'text-red-800'
                          }`}>
                            Feedback :
                          </h6>
                          <p className={`text-sm ${
                            choice.style === 'Assertif' ? 'text-green-700' :
                            choice.style === 'Passif' ? 'text-gray-700' :
                            'text-red-700'
                          }`}>
                            {choice.feedback}
                          </p>
            ...
            <div className="flex justify-between items-center pt-4">
              ...
              <Button 
                ...
                disabled={currentScenario === scenarios.length - 1 || !scenarioChoices[currentScenario]}
                className="flex items-center gap-2"
              >
                Suivant
      ...
      <Card className="mb-8">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Quiz de validation
            {completedExercises.includes('quiz') && <CheckCircle className="w-5 h-5 text-green-500" />}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
              ...
              <div key={qIndex} className="border rounded-lg p-4">
                ...
                {communicationStyleQuiz[qIndex] && (
                  <div className={`p-3 rounded border text-sm ${
                    communicationStyleQuiz[qIndex] === question.options[question.correct]
                      ? 'bg-green-50 border-green-200 text-green-700'
                      : 'bg-red-50 border-red-200 text-red-700'
                  }`}>
                    {communicationStyleQuiz[qIndex] === question.options[question.correct] ? '✓ Correct !' : '✗ Incorrect.'} 
                    {communicationStyleQuiz[qIndex] === question.options[question.correct] 
        ...
        <Card className="bg-green-50 border-green-200">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-green-700 mb-4">
              Vous savez maintenant communiquer de manière assertive et gérer les relations difficiles. 
              Prêt pour créer votre plan d'action personnel ?
            </p>
          </CardContent>
        </Card>
      )}
      ...
      <Card className="bg-gradient-to-br from-green-50 to-calm-50 border-green-200">
        <CardContent className="p-8">
          ...
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            Vous maîtrisez maintenant la communication assertive et les techniques de gestion relationnelle. 
            Ces compétences vous permettront de gérer efficacement les situations interpersonnelles stressantes.
          </p>
          
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="font-bold text-gray-900 mb-3">Compétences développées :</h4>
