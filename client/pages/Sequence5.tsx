...
const Sequence5 = () => {
  ...
  const finalQuiz = [
    {
      question:
        "Quelle est la première étape cruciale dans la gestion du stress ?",
      options: [
      ...
      correct: 1,
      explanation:
        "Identifier ses déclencheurs permet de comprendre les sources de stress et d'adapter ses stratégies.",
    },
    {
      ...
      correct: 0,
      explanation:
        "Les tâches urgentes ET importantes doivent être traitées en premier (quadrant 1).",
    },
    {
      question:
        "Quelle technique de respiration est recommandée pour l'anxiété ?",
      options: [
      ...
      correct: 2,
      explanation:
        "La technique 4-7-8 active le système parasympathique et réduit l'anxiété efficacement.",
    },
    {
      question: 'Dans le modèle DESC, que signifie le "E" ?',
      options: ["Éliminer", "Exprimer (ses émotions)", "Évaluer", "Éviter"],
      correct: 1,
      explanation:
        'Le "E" signifie Exprimer ses émotions et sentiments de manière authentique.',
    },
    {
      question:
        "Combien de tâches essentielles maximum par jour pour rester efficace ?",
      options: ["1", "3", "7", "Pas de limite"],
      correct: 1,
      explanation:
        "3 tâches essentielles permettent de maintenir le focus sans se disperser.",
    },
  ];
...
Module "Réguler le stress" - Builder.io Learning
  ...
  const getQuizScore = () => {
    return Object.entries(quizAnswers).filter(
      ([qIndex, answer]) => answer === finalQuiz[parseInt(qIndex)].correct,
    ).length;
  };

  const isActionPlanComplete =
    actionPlan.triggers &&
    actionPlan.favoriteTechniques &&
    ...
    <div className="max-w-4xl mx-auto text-center mb-8">
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-nature-200">
        ...
        <p className="text-xl text-gray-600 mb-6 leading-relaxed">
          Créez votre stratégie personnalisée de gestion du stress, établissez
          votre routine quotidienne et validez vos connaissances avec le quiz
          final du module.
        </p>
        ...
        <div className="bg-blue-50 p-6 rounded-lg mb-6">
          <h3 className="font-semibold text-blue-900 mb-2">
            Objectifs de cette séquence finale :
          </h3>
    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Félicitations ! Vous avez terminé les 4 premières séquences. Voici un
          récapitulatif de votre apprentissage.
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center p-4 bg-red-50 rounded-lg">
              ...
              <p className="text-red-700 text-xs">
                Environnementaux, Organisationnels, Relationnels, Internes
              </p>
            </div>
            ...
            <div className="text-center p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-green-700 text-xs">
                Matrice Eisenhower, Reframing, 3 tâches essentielles
              </p>
            </div>
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-purple-700 text-xs">
                Modèle DESC, Communication assertive
              </p>
            </div>
          </div>
        </CardContent>
  ...
  const ActionPlanStep = () => (
    <div className="max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Définissez votre stratégie personnelle et votre routine quotidienne
          anti-stress.
        </p>
      </div>
        ...
        <CardContent>
          <div className="mb-4">
            <p className="text-gray-600 mb-4">
              Sélectionnez 3-4 éléments pour créer votre routine de 5 minutes
              maximum :
            </p>
  ...
  const QuizStep = () => (
    <div className="max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mb-4">
          Validez vos connaissances avec ce quiz de 5 questions sur l'ensemble
          du module.
        </p>
        <Progress
          value={(Object.keys(quizAnswers).length / finalQuiz.length) * 100}
          className="h-3"
        />
      </div>
        ...
        <Card className="mt-8 bg-green-50 border-green-200">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-green-700 mb-4">
              Score: {getQuizScore()}/{finalQuiz.length} (
              {Math.round((getQuizScore() / finalQuiz.length) * 100)}%)
            </p>
            <Badge
              className={
                getQuizScore() >= 4
      ...
      <Card className="bg-gradient-to-br from-green-50 to-nature-50 border-green-200">
        <CardContent className="p-8">
          ...
          <p className="text-xl text-gray-700 mb-6 leading-relaxed">
            Félicitations ! Vous avez terminé le module "Réguler le stress" et
            acquis toutes les compétences nécessaires pour une gestion efficace
            du stress.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <ul className="text-left space-y-2 text-gray-600">
                ...
                <li>
                  ✅ {Object.keys(quizAnswers).length} questions de quiz
                  réussies
                </li>
